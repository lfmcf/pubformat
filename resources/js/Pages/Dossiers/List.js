...
const List = (props) => {
    ...
    const handleNavigate = () => {
        if (form && form.value == "Formatting") {
            ...
            Inertia.visit('/publishing', {
                method: 'get',
                data: {form : form.value, region: region.value, procedure: procedure.value, product: product.value, country: country},
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                }
            })
    ...
    useEffect(() => {
        ...
        if(form && form.value === 'Publishing') {
            if(region && region.value == 'GCC') {
                setProcedure({label: 'Nationale', value: 'Nationale'});
                setProductList(gccproduct);
                setCountryList(gcccountry);
            }else if(region && region.value == 'CH') {
                setProcedure({label: 'Nationale', value: 'Nationale'});
                setProductList(chproduct);
                setCountryList([{label: 'Switzerland', value: 'Switzerland'}])
                setCountry({label: 'Switzerland', value: 'Switzerland'})
            }
            // region && region.value == 'GCC' || region.value == 'CH' ? setProcedure({label: 'Nationale', value: 'Nationale'}) : ''
        }
    ...
    useEffect(() => {
        if(form && form.value === 'Publishing') {
            if (region && region.value == 'EU' && procedure && procedure.value == 'Decentralized') {
                setProductList([{label: 'ACTAIR', value: 'ACTAIR'}])
                setCountryList(eunatcountry)
                setCompselect(true)
            }else if (region && region.value == 'EU' && procedure && procedure.value == 'Mutual Recognition') {
                setProductList([{label: 'ORALAIR', value: 'ORALAIR'}])
                setCountryList(eunatcountry)
                setCompselect(true)
            }else if (region && region.value == 'EU' && procedure && procedure.value == 'Nationale' || procedure && procedure.value == 'Centralized' ){
            ...
            <Dialog open={open} onClose={handleClose} maxWidth='sm' fullWidth={true}>
                ...
                <DialogContent>
                    ...
                    <div className='modal_form'>
                        ...
                        <Select options={form && form.value == 'Publishing' ? publishingRegion : formattingRegion}
                            name="Region"
