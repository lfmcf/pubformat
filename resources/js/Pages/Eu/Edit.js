...
const Edit = (props) => {
    ...
    const { data, setData, post, processing, errors, clearErrors, reset } = useForm({
        id: eu.id,
        responsable: eu.responsable,
        eventName: eu.eventName,
        concernedCountry: eu.concernedCountry,
        referenceDeficiencyLetter: eu.referenceDeficiencyLetter,
        ProductNameFini: eu.ProductNameFini,
        substanceNameActive: eu.substanceNameActive,
        dossierReference: eu.dossierReference,
        documentsNumber: eu.documentsNumber,
        demandeDate: moment(eu.demandeDate,).format('YYYY-MM-DD HH:mm:ss'),
        deadline: moment(eu.deadline,).format('YYYY-MM-DD HH:mm:ss'),
        status: eu.status,
        type: eu.type,
        action: eu.action,
        submissionCountry: eu.submissionCountry,
        uuid: eu.uuid,
        submissionType: eu.submissionType,
        submissionMode: eu.submissionMode,
        trackingNumber: eu.trackingNumber,
        submissionUnit: eu.submissionUnit,
        applicant: eu.applicant,
        agencyCode: eu.agencyCode,
        procedureType: eu.procedureType,
        inventedName: eu.inventedName,
        inn: eu.inn,
        sequence: eu.sequence,
        relatedSequence: eu.relatedSequence,
        submissionDescription: eu.submissionDescription,
        indication: eu.indication,
        drugSubstanceName: JSON.parse(eu.drugSubstanceName),
        substanceManufacturer: JSON.parse(eu.substanceManufacturer),
        drugProduct: JSON.parse(eu.drugProduct),
        dosageForm: eu.dosageForm,
        manufacturer: eu.manufacturer,
        excipient: eu.excipient,
        formtype: 'eu',
        formstatus: eu.formstatus,
    });
...
Edit.layout = page => <Authenticated children={page} auth={page.props.auth} header="EU From - EDIT" />